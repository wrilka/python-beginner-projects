...
def compare(user_score, computer_score):
	if user_score == computer_score:
		...
		return "You Lose! You have more than 21"
	elif computer_score > 21:
		return "You win! Computer have more than 21"
...
while not game_end:
	...
	if user_score == 0 and computer_score == 0 and user_score > 21:
		...
		another = input("Do you want to draw another card or pass. 'y' to yes and 'n' to pass").lower()
